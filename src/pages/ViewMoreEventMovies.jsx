...
const options1 = [
  ...
  { id: 1, value: "Music Concerts", subcat: "Music Concerts" },
  { id: 2, value: "Art Exhibitions", subcat: "Art Exhibitions" },
  { id: 3, value: "Theater Performances", subcat: "Theater Performances" },
  { id: 4, value: "Film Screenings", subcat: "Film Screenings" },
  { id: 5, value: "Community Festivals", subcat: "Community Festivals" },
  {
    id: 6,
    value: "Food and Drink Festivals",
    subcat: "Food and Drink Festivals",
  },
  { id: 7, value: "Sports Events", subcat: "Sports Events" },
  { id: 8, value: "Charity Fundraisers", subcat: "Charity Fundraisers" },
  {
    id: 9,
    value: "Cultural Celebrations",
    subcat: "Cultural Celebrations",
  },
  {
    id: 10,
    value: "Workshops and Classes",
    subcat: "Workshops and Classes",
  },
  { id: 11, value: "Outdoor Activities", subcat: "Outdoor Activities" },
  {
    id: 12,
    value: "Family-Friendly Events",
    subcat: "Family-Friendly Events",
  },
  { id: 13, value: "Movie Premieres", subcat: "Movie Premieres" },
  { id: 14, value: "Film Festivals", subcat: "Film Festivals" },
  {
    id: 15,
    value: "Documentary Screenings",
    subcat: "Documentary Screenings",
  },
  ...
  const getAllListingData = async () => {
    ...
    try {
      ...
      const LocalRentals = res?.data?.filter(
        (item) =>
          item?.category === "Local Events & Movies" &&
          item?.status === "active"
      );
...
export default ViewMoreEventMovies;
