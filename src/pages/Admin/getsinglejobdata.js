...
const Getsinglejobdata = () => {
  ...
  const { address, createdBy } = getdata;
  const createdByUser = createdBy?.[0] || {};
  const { name, email } = createdByUser;
  return (
    <AdminLayout>
      <section className="w-full overflow-hidden mt-3">
        <div className="flex flex-col">
          ...
          <div className="sm:w-[80%] xs:w-[90%] mx-auto flex">
            ...
            />
            {/* FullName */}
            <h1 className="w-full text-left mt-4 sm:mx-4 xs:pl-4 text-gray-800 lg:text-4xl md:text-3xl sm:text-3xl xs:text-xl font-serif">
              {name}
            </h1>
          </div>
          <div className="xl:w-[80%] lg:w-[90%] md:w-[90%] sm:w-[92%] xs:w-[90%] mx-auto flex flex-col gap-4 items-center relative lg:-top-8 md:-top-6 sm:-top-4 xs:-top-4">
            ...
            <div className="w-full my-auto py-6 flex flex-col justify-center gap-2">
              <div className="w-full flex sm:flex-row xs:flex-col gap-2 justify-center">
                <div className="w-full">
                  <dl className="text-gray-900 divide-y dark:divide-gray-700">
                    <div className="flex flex-col pb-3">
                      <dt className="mb-1 text-gray-500 md:text-base">Name</dt>
                      <dd className="text-base font-semibold">{name}</dd>
                    </div>
                    {/* <div className="flex flex-col py-3">
                      <dt className="mb-1 text-gray-500 md:text-base">
                        Last Name
                      </dt>
                      <dd className="text-base font-semibold">Abera</dd>
                    </div> */}
                    {/* <div className="flex flex-col py-3">
                      <dt className="mb-1 text-gray-500 md:text-base">Address</dt>
                      <dd className="text-base font-semibold"> {address}</dd>
                    </div> */}
                    <div className="flex flex-col py-3">
                      <dt className="mb-1 text-gray-500 md:text-base">
                        Gender
                      </dt>
                      <dd className="text-base font-semibold">female</dd>
                    </div>
                  </dl>
                </div>
                <div className="w-full">
                  <dl className="text-gray-900 divide-y dark:divide-gray-700">
                    ...
                    <div className="flex flex-col pt-3">
                      ...
                      <dd className="text-base font-semibold">+251913****30</dd>
                    </div>
                    <div className="flex flex-col pt-3">
                      <dt className="mb-1 text-gray-500 md:text-base">Email</dt>
            ...
            {/* Social Links */}
            {/* <div className="fixed right-2 bottom-20 flex flex-col rounded-sm bg-gray-200 text-gray-500 dark:bg-gray-200/80 dark:text-gray-700 hover:text-gray-600 hover">
