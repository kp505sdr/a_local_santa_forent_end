  ...
  const updateSmtpData = async () => {
    try {
      const res = await axios.post(
        `${process.env.REACT_APP_API}/api/v1/create-email-config`,smtpData,{
          headers: {
        ...
        <div className="flex flex-wrap">
          <div className="w-full xl:w-8/12 mb-12 xl:mb-0 px-4">
            ...
            <div className="max-w-md mx-auto mt-10 bg-white shadow-lg rounded-lg overflow-hidden">
              ...
              <p className='text-red-600 font-semibold text-sm  text-center'>{Message}</p>
              <form onSubmit={HandleSubmit} className="py-4 px-6">
                ...
                <div className="flex items-center justify-center mb-4">
                  <button
                    className="bg-blue-600 text-white py-2 px-4 rounded hover:bg-blue-800 focus:outline-none focus:shadow-outline"
                    type="submit"
                  >
                    Create Port
                  </button>
