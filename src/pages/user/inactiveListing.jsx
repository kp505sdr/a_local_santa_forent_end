...
import UserInactiveTable from '../../components/Table/UserInactiveTable';
...
const InactiveListing = () => {
    ...
    const getAllJobData = async () => {
      try {
        ...
        const pendingData=res?.data.filter(item => item.status=="inactive")
        ...
        <div className="my-5">
          <div className="flex flex-wrap">
            <div className="w-full xl:w-8/12 mb-12 xl:mb-0 px-4">
              ...
              <UserInactiveTable pendingData={pendingData} />
