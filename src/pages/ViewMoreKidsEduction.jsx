...
// const ViewMoreKidsEduction = () => {
//   return (
//     <div>ViewMoreKidsEduction</div>
//   )
// }

// export default ViewMoreKidsEduction
...
const options1 = [
  { id: 0, value: "", subcat: "Select Subcategory" },
  {
    ...
    subcat: "Early Childhood Development",
  },
  {
    id: 2,
    value: "Parenting Tips and Advice",
    subcat: "Parenting Tips and Advice",
  },
  {
    id: 3,
    value: "Child Health and Nutrition",
    subcat: "Child Health and Nutrition",
  },
  {
    id: 4,
    value: "Educational Toys and Games",
    subcat: "Educational Toys and Games",
  },
  {
    id: 5,
    value: "Preschool and Kindergarten",
    subcat: "Preschool and Kindergarten",
  },
  {
    id: 6,
    value: "Elementary School Education",
    subcat: "Elementary School Education",
  },
  {
    id: 7,
    value: "Middle School Education",
    subcat: "Middle School Education",
  },
  {
    id: 8,
    value: "High School Education",
    subcat: "High School Education",
  },
  { id: 9, value: "Homeschooling", subcat: "Homeschooling" },
  {
    id: 10,
    value: "Extracurricular Activities",
    subcat: "Extracurricular Activities",
  },
  {
    id: 11,
    value: "Learning Disabilities and Special Needs",
    subcat: "Learning Disabilities and Special Needs",
  },
  {
    id: 12,
    value: "Parent-Teacher Communication",
    subcat: "Parent-Teacher Communication",
  },
  {
    id: 13,
    value: "School Events and Activities",
    subcat: "School Events and Activities",
  },
  { id: 14, value: "Child Psychology", subcat: "Child Psychology" },
  { id: 15, value: "Positive Discipline", subcat: "Positive Discipline" },
  ...
  const getAllListingData = async () => {
    ...
    try {
      ...
      const LocalRentals = res?.data?.filter(
        (item) =>
          item?.category === "Parenting and kid's education" &&
          item?.status === "active"
      );
