...
const options1 = [
  ...
  {
    id: 1,
    value: "Real Estate Rentals",
    subcat: "Real Estate Rentals",
  },
  {
    id: 2,
    value: "Vehicle Rentals",
    subcat: "Vehicle Rentals",
  },

  {
    id: 3,
    value: "Equipment Rentals",
    subcat: "Equipment Rentals",
  },
  {
    id: 4,
    value: "Event Rentals",
    subcat: "Event Rentals",
  },
  {
    id: 5,
    value: "Vacation Rentals",
    subcat: "Vacation Rentals",
  },
  {
    id: 6,
    value: "Clothing Rentals",
    subcat: "Clothing Rentals",
  },
  {
    id: 7,
    value: "Art and Décor Rentals",
    subcat: "Art and Décor Rentals",
  },
  {
    id: 8,
    value: "Others",
  ...
  const getAllListingData = async () => {
    ...
    try {
      ...
      const LocalRentals = res?.data?.filter(
        (item) =>
          item?.category === "Local rentals" && item?.status === "active"
      );
...
export default ViewMoreLocalRental;
