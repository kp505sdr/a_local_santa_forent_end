...
// const ViewMoreHealthWellness = () => {
//   return (
//     <div>ViewMoreHealthWellness</div>
//   )
// }

// export default ViewMoreHealthWellness
...
const options1 = [
  ...
  { id: 1, value: "Exercise and Fitness", subcat: "Exercise and Fitness" },
  { id: 2, value: "Nutrition and Diet", subcat: "Nutrition and Diet" },
  {
    id: 3,
    value: "Mental Health and Well-being",
    subcat: "Mental Health and Well-being",
  },
  { id: 4, value: "Stress Management", subcat: "Stress Management" },
  { id: 5, value: "Sleep Health", subcat: "Sleep Health" },
  { id: 6, value: "Holistic Health", subcat: "Holistic Health" },
  { id: 7, value: "Yoga and Meditation", subcat: "Yoga and Meditation" },
  { id: 8, value: "Alternative Medicine", subcat: "Alternative Medicine" },
  { id: 9, value: "Self-Care", subcat: "Self-Care" },
  { id: 10, value: "Weight Management", subcat: "Weight Management" },
  { id: 11, value: "Women's Health", subcat: "Women's Health" },
  { id: 12, value: "Men's Health", subcat: "Men's Health" },
  {
    id: 13,
    value: "Aging and Elderly Care",
    subcat: "Aging and Elderly Care",
  },
  {
    id: 14,
    value: "Chronic Illness Management",
    subcat: "Chronic Illness Management",
  },
  { id: 15, value: "Addiction Recovery", subcat: "Addiction Recovery" },
  ...
  const getAllListingData = async () => {
    ...
    try {
      ...
      const LocalRentals = res?.data?.filter(
        (item) =>
          item?.category === "Health and Wellness" && item?.status === "active"
      );
