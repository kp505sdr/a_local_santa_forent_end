...
const options1 = [
  ...
  { id: 1, value: "Electronics", subcat: "Electronics" },
  { id: 2, value: "Vehicles", subcat: "Vehicles" },
  {
    id: 3,
    value: "Clothing and Accessories",
    subcat: "Clothing and Accessories",
  },
  { id: 4, value: " Home and Garden", subcat: " Home and Garden" },
  {
    id: 5,
    value: "Electronics Accessories",
    subcat: "Electronics Accessories",
  },
  { id: 6, value: "Toys and Games", subcat: "Toys and Games" },
  {
    id: 7,
    value: "Sports and Fitness Equipment",
    subcat: "Sports and Fitness Equipment",
  },
  { id: 8, value: "Books and Magazines", subcat: "Books and Magazines" },
  {
    id: 9,
    value: " Health and Beauty Products",
    subcat: " Health and Beauty Products",
  },
  { id: 10, value: "Baby and Kids Items", subcat: "Baby and Kids Items" },
  { id: 10, value: "Musical Instruments", subcat: "Musical Instruments" },
  { id: 11, value: "Craft Supplies", subcat: "Craft Supplies" },
  { id: 12, value: " Pet Supplies", subcat: " Pet Supplies" },
  {
    id: 13,
    value: "Outdoor Gear and Equipment",
    subcat: "Outdoor Gear and Equipment",
  },
  { id: 14, value: "Others", subcat: "Others" },
];
  ...
  const getAllListingData = async () => {
    ...
    try {
      ...
      const FilterBuyAndSellData = res?.data.filter(
        (item) =>
          (item?.category === "Buy - Sell" || item?.category === "Buy-Sell") &&
          item?.status === "active"
      );
      setListingData(FilterBuyAndSellData);
      setLoading(false);
      // -------------------filter-by---subcategory------------------------------
      if (Subcategory !== "") {
        const sortBySub = FilterBuyAndSellData?.filter(
      ...
      if (selectedAlphabet !== "") {
        const filteredData = FilterBuyAndSellData?.filter((value) =>
      ...
      if (!selectDate == "") {
        ...
        const filteredByDate = FilterBuyAndSellData.filter(
...
export default ViewMoreBuySell;
