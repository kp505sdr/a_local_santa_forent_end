...
// const UserInactiveTable = () => {
//   return (
//     <div>UserInactiveTable</div>
//   )
// }

// export default UserInactiveTable
...
const UserInactiveTable = ({pendingData}) => {
...
//       const activeData = res.data.filter((item) => item.status === "pending");
